...
declare module 'react-navigation' {
  ...
  declare export type NavigationTabScreenOptions = {|
    ...
    tabBarOnPress?: (scene: TabScene, jumpToIndex: (index: number) => void) => void,
  |};
  ...
  declare export type NavigationDispatch = (action: PossiblyDeprecatedNavigationAction) => boolean;
  ...
  declare export var NavigationActions: {
    ...
    mapDeprecatedActionAndWarn: (action: PossiblyDeprecatedNavigationAction) => NavigationAction,
  };

  declare type _RouterProp<S: NavigationState, O: {}> = {
    router: NavigationRouter<S, O>,
  };
  declare type _NavigatorCreator<NavigationViewProps: {}, S: NavigationState, O: {}> = (
